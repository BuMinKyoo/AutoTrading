...
{
    public class MultiFibonacciColorConverter : IMultiValueConverter
    {
        // ViewModel -> View
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            try
            {
                ...
                if (stockLast != 0 && red != null && orange != null && green != null && blue != null && purple != null)
                {
                    ...
                    else if (stockLast < red)
                        return Brushes.Red;
                    else
                    {
                        // 진한 노란색 (단풍색, 거의 갈색 느낌)
                        return new SolidColorBrush(Color.FromRgb(204, 102, 0)); // RGB(204,102,0): 브라운-옐로우
                    }
                }
                else
                {
